...
const NameCard: React.FC = () => {
  ...
  return (
    <div className={styles.nameCard} data-language={language}>
      <svg className={styles.watermark} viewBox="0 0 73 52" aria-hidden="true" focusable="false">
        <path className={styles.markPath} d="M6 44V8l15 19L36 8v36" />
        <path className={styles.markPath} d="M36 8h10c13 0 21 7 21 18s-8 18-21 18H36" />
