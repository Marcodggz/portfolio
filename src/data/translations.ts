export const translations = {
  en: {
    ...
    home: {
      ...
      agentWorkflowsHeading: 'Agent workflows',
      availabilityHeading: 'Availability',
      availabilityIntro: 'Open to new opportunities',
      contactCta: 'Contact',
      availabilityFacts: [
        { label: 'Work setup', value: 'Remote, hybrid & on-site' },
        { label: 'Based in', value: 'Spain · open to relocation' },
        { label: 'Engagement', value: 'Full-time · Freelance · Project-based' },
  ...
  es: {
    ...
    home: {
      ...
      agentWorkflowsHeading: 'Flujos con agentes',
      availabilityHeading: 'Disponibilidad',
      availabilityIntro: 'Abierto a nuevas oportunidades',
      contactCta: 'Contacto',
      availabilityFacts: [
        { label: 'Modalidad de trabajo', value: 'Remoto, híbrido y presencial' },
        { label: 'Ubicación', value: 'España · disponible para reubicación' },
        { label: 'Disponibilidad', value: 'Jornada completa · Freelance · Por proyecto' },
